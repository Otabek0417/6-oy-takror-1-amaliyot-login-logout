      ...
      >
        ...
        <div className="mb-1 flex items-center justify-center gap-2">
          ...
          <button
            ...
            className="w-24 rounded-lg border bg-blue-700 py-2 text-base font-medium text-white"
          >
            add
          </button>
        </div>
        ...
        <button className=" w-full rounded-md border bg-blue-700 py-2 text-base font-medium text-white">
          Submit
        </button>
      </form>
    </div>
